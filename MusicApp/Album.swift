...
let albumlist: [Album] = [
    .init(id: 2, name: "Eternal Atake", artist: "Lil Uzi", albumArtString: "eternalatake-liluzivert", publishDate: "Mar 6, 2020", description: "Eternal Atake is the second studio album by American rapper Lil Uzi Vert. After being initially announced in 2018, the album was released on March 6, 2020 through Atlantic Records. The album was supported by the singles \"Futsal Shuffle 2020\" and \"That Way\". The album features a guest appearance from American singer Syd. <a href=\"http://www.last.fm/music/LIL+UZI+VERT/Eternal+Atake\">Read more on Last.fm</a>."),
